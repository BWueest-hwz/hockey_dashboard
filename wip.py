...
optionL = st.selectbox(
    " ",
    ["Liga auswählen...", "National League", "Women's League", "Swiss League", "MySports League", "1. Liga", "U21-Elit"]
)
...
if optionT and optionT != "Bitte ein Team auswählen...":
    # Display team logo and name
    col1, col2 = st.columns([0.75, 3])
    with col1:
        img_path = teams.loc[teams['team_name'] == optionT, 'png_url'].values[0]
        st.image(img_path, width=150)
    with col2:
        st.markdown(f"# {optionT}")
    ...
    with tab1:
        with st.container(height=700):
            ...
            wins_data = wins_ema[wins_ema['Team'] == optionT]
    ...
    with tab2:
        ...
        points_data = points_ema[points_ema['Team'] == optionT]
    ...
    with tab3:
        ...
        ppe_data = ppe_ema[ppe_ema['Team'] == optionT]
    ...
    with tab4:
        ...
        pke_data = pke_ema[pke_ema['Team'] == optionT]
    ...
    with tab5:
        ...
        scoring_data = scoring_ema[scoring_ema['Team'] == optionT]
    ...
    with tab6:
        ...
        defense_data = defense_ema[defense_ema['Team'] == optionT]
    ...
    with tab7:
        ...
        turnover_data = turnover_ema[turnover_ema['Team'] == optionT]
    ...
    with tab8:
        ...
        spectators_data = spectators_ema[spectators_ema['Team'] == optionT]
